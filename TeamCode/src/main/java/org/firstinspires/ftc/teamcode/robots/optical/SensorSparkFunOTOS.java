package org.firstinspires.ftc.teamcode.robots.optical;
...
public class SensorSparkFunOTOS extends LinearOpMode {
    ...
    public void mecanumDrive(double forward, double strafe, double turn) {
        ...
        double rightX = turn;
        double powerFrontLeft = r * Math.cos(robotAngle) - rightX;
        double powerFrontRight = r * Math.sin(robotAngle) + rightX;
        double powerBackLeft = r * Math.sin(robotAngle) - rightX;
        double powerBackRight = r * Math.cos(robotAngle) + rightX;
    ...
    private void configureOtos() {
        ...
        SparkFunOTOS.Pose2D offset = new SparkFunOTOS.Pose2D(.75, 3, 0);
        ...
        myOtos.setLinearScalar(35.0/33.3);
