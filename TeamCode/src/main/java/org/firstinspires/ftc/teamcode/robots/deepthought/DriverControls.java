...
import org.firstinspires.ftc.teamcode.robots.deepthought.subsystem.Intake;
...
import org.firstinspires.ftc.teamcode.robots.deepthought.subsystem.Skyhook;
...
public class DriverControls {
    ...
    public void joystickDrive() {
        ...
        if(stickyGamepad1.dpad_left) {
            if(IntoTheDeep_6832.autoNav.setPreferredRoute(IntoTheDeep_6832.autoNav.preferredRoute-1) < 0) {
                IntoTheDeep_6832.autoNav.setPreferredRoute(6);
            }
        }
        if(stickyGamepad1.dpad_right) {
            if(IntoTheDeep_6832.autoNav.setPreferredRoute(IntoTheDeep_6832.autoNav.preferredRoute+1) > 6) {
                IntoTheDeep_6832.autoNav.setPreferredRoute(0);
            }
        }
        ...
        if(stickyGamepad2.start) {
            if(IntoTheDeep_6832.AUTONAV_ENABLED) {
                IntoTheDeep_6832.autoNavOn = !IntoTheDeep_6832.autoNavOn;
            }
        }
        else if(shifted(gamepad2) && stickyGamepad2.start) {
            IntoTheDeep_6832.autoEndgameOn = !IntoTheDeep_6832.autoEndgameOn;
        }
