...
//    public static double BLUE_ALLIANCE_VALUE_MIN = 80, BLUE_ALLIANCE_VALUE_MAX = 180;
    public static double BLUE_ALLIANCE_HUE_MIN = 0, BLUE_ALLIANCE_HUE_MAX = 50;
    public static double BLUE_ALLIANCE_SATURATION_MIN = 150, BLUE_ALLIANCE_SATURATION_MAX = 190;
    public static double BLUE_ALLIANCE_VALUE_MIN = 130, BLUE_ALLIANCE_VALUE_MAX = 200;
