...
import org.firstinspires.ftc.teamcode.robots.deepthought.vision.pipeline.CSBotPropDetectorPipeline;
...
public class CSBotPropDetectorProvider extends VisionProvider {
    ...
    public void initializeVision(HardwareMap hardwareMap, boolean isFront) {
        pipeline = new CSBotPropDetectorPipeline(isRedAlliance, isFront);
        if(!isFront) {
