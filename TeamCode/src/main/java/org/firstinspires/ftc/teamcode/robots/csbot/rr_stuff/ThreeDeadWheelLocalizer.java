...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = -(6.75 / MecanumDrive.PARAMS.inPerTick); // y position of the first parallel encoder (in tick units)
        public double par1YTicks = 6.75 / MecanumDrive.PARAMS.inPerTick; // y position of the second parallel encoder (in tick units)
