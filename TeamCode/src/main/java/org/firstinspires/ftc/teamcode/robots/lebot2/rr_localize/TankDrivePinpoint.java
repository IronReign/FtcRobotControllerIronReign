...
/**
 * TankDrive variant using Pinpoint odometry instead of drive wheel encoders.
 * This provides more accurate localization since dedicated odometry pods
 * don't suffer from wheel slip like drive motors do.
 */
@Config
public final class TankDrivePinpoint {
    public static class Params {
        // drive model parameters
        public double inPerTick = 1.0; // Pinpoint reports in inches, so 1:1 mapping
        public double trackWidthTicks = 0; // still needed for kinematics
    ...
    public TankDrivePinpoint(HardwareMap hardwareMap, Pose2d pose) {
        ...
        // Use Pinpoint for localization instead of drive wheel encoders
