...
import org.firstinspires.ftc.teamcode.robots.bobobot.RoadRunning.LocalizationTest;
import org.firstinspires.ftc.teamcode.robots.bobobot.RoadRunning.ManualFeedbackTuner;
...
public final class TuningOpModes {
    ...
    private static OpModeMeta metaForClass(Class<? extends OpMode> cls) {
        return new OpModeMeta.Builder()
                .setName(cls.getSimpleName().concat("_BOB"))
                .setGroup(GROUP)
