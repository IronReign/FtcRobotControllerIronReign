...
public class Field {
    ...
    public void finalizeField(Constants.Alliance alliance) {
        ...
        basket = new POI(-2.4 * allianceMultiplier, -2.4 * allianceMultiplier, isRed ? 56 : 56 + 180, "BASKET");
        ...
        ground2 = new POI(-2 * allianceMultiplier, -1.8 * allianceMultiplier, isRed ? 85 : 85 + 180, "GROUND2");
