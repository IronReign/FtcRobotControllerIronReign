...
import org.firstinspires.ftc.teamcode.rrQuickStart.TankDrive; //haven't ported this yet

import org.firstinspires.ftc.teamcode.rrQuickStart.TwoDeadWheelLocalizer; //haven't ported this yet
...
public final class TuningOpModes {
    ...
    public static void register(OpModeManager manager) {
        ...
        if (DRIVE_CLASS.equals(MecanumDriveReign.class)) {
            dvf = hardwareMap -> {
                MecanumDriveReign md = new MecanumDriveReign(hardwareMap, new Pose2d(0, 0, 0));

                List<Encoder> leftEncs = new ArrayList<>(), rightEncs = new ArrayList<>();
                List<Encoder> parEncs = new ArrayList<>(), perpEncs = new ArrayList<>();
                if (md.localizer instanceof MecanumDriveReign.DriveLocalizer) {
                    MecanumDriveReign.DriveLocalizer dl = (MecanumDriveReign.DriveLocalizer) md.localizer;
                ...
                return new DriveView(
                    DriveType.MECANUM,
                        MecanumDriveReign.PARAMS.inPerTick,
                        MecanumDriveReign.PARAMS.maxWheelVel,
                        MecanumDriveReign.PARAMS.minProfileAccel,
                        MecanumDriveReign.PARAMS.maxProfileAccel,
                        ...
                        md.lazyImu,
                        md.voltageSensor,
                        () -> new MotorFeedforward(MecanumDriveReign.PARAMS.kS,
                                MecanumDriveReign.PARAMS.kV / MecanumDriveReign.PARAMS.inPerTick,
                                MecanumDriveReign.PARAMS.kA / MecanumDriveReign.PARAMS.inPerTick)
                );
            };
