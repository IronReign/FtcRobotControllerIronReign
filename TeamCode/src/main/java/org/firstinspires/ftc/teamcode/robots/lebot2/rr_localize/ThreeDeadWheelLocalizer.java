...
import org.firstinspires.ftc.teamcode.rrQuickStart.messages.ThreeDeadWheelInputsMessage;

@Config
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = -2155.20134371; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = 3244.296280586008; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = -2654.3979175644404; // x position of the perpendicular encoder (in tick units)
        }
