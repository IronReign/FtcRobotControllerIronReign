...
//    static AutoNav autoNav;
    ...
    public enum GameState {
        //MAIN OPMODES
        QUICKTRIP("QuickTrip", true),
        TELE_OP("Tele-Op"),

        //TEST & TEMP MODES
        TEST("Test"),
        FOURSQUARE("Auto-Specimens", true),
        SIXCAN("Auto-Spec-Sweep", true),
        BARRELRACE("Demo"),
        ...
        public static GameState getGameState(int gameStateIndex) {
            switch (gameStateIndex) {
                case 0:
                    return GameState.QUICKTRIP;
                case 1:
                    return GameState.TELE_OP;
                case 2:
                    return GameState.TEST;
                case 3:
                    return GameState.FOURSQUARE;
                case 4:
                    return GameState.SIXCAN;
                case 5:
                    return GameState.RELOCALIZATION_TEST;
                case 6:
                    return GameState.BARRELRACE;
                default:
                    return GameState.TEST;
            }
        }
    ...
    public static GameState gameState = GameState.QUICKTRIP;
...
//        if (gameState.equals(GameState.TEST) || gameState.equals(GameState.BARRELRACE)) {
//            robot.trident.calibrated = true;
//            robot.driveTrain.setPose(startingPosition);
//        }
