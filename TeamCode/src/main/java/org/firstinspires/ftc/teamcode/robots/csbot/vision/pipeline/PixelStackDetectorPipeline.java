...
public class PixelStackDetectorPipeline extends TimestampedOpenCvPipeline {
    ...
    public static double HUE_MIN = 90, HUE_MAX = 120;
    public static double SATURATION_MIN = 120, SATURATION_MAX = 140;
    public static double VALUE_MIN = 110, VALUE_MAX = 255;
    ...
    public PixelStackDetectorPipeline() {
        largestX = -1;
        largestY = -1;
        largestArea = -1;
    ...
    public Mat processFrame(Mat input, long timestamp) {
        ...
        hsvThresholdHue = new double[]{HUE_MIN, HUE_MAX};
        hsvThresholdSaturation = new double[]{SATURATION_MIN, SATURATION_MAX};
        hsvThresholdValue = new double[]{VALUE_MIN, VALUE_MAX};
