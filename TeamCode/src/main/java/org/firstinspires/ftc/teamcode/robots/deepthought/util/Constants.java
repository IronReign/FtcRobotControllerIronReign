...
public class Constants {
    ...
    public enum Position {
        ...
        START_RIGHT_RED_BACK(P2D(0.5, -2.6, -90)), //start backwards for specimens
        START_RIGHT_RED(P2D(0.5, -2.6, 45)), //start angled at alliance floor samples
        START_RIGHT_BLUE(P2D(0.5, 2.6, -45)), //start angled at alliance floor samples
        START_RIGHT_BLUE_BACK(P2D(-0.5, 2.6, 90)), //start backwards for specimens
